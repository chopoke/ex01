						...
						<div class="join">
							<form name="loginform" action="loginaction.do" method="post" >
									...
									<c:if test="${sessionScope.sessionid == null}">
										<script type="text/javascript">alert("아이디와 비밀번호가 일치하지 않습니다.");</script>
										...
										<table align="center">
											...
											<tr>
												<th colspan="2" align="center">
													<span style="color: orange"><b>${sessionScope.sessionid}</span>님 반갑습니다.</b>
												</th>
											</tr>
											...
											<tr>
												<td colspan="2" style="border-bottom: none;">
													<div align="right">
														...
														<input class="inputbutton" type="button" value="홈으로" onclick="window.location='${path}/main'">
														
														<!-- admin/1234로 가입후 admin으로 로그인 할때만 관리자 링크 보이게 하기 -->
														<c:if test="${sessionScope.sessionid == 'admin'}">
															<%-- <button><a href="${path}/board_list.bc">관리자</a></button> --%>
															<input class="inputbutton" type="button" value="관리자" onclick="window.location='${path}/board_list.bc'">
